package l_elvis_unit

import j_data_class.Assistant
import j_data_class.Director
import j_data_class.Worker
import java.io.File
...
object WorkersDataManager {
    ...
    val workers: Set<Worker>
        ...
        //Но если мы изменим элемент в новой коллекции(его поле var), то в старой коллекции тоже изменится этот элемент
        get() = _workers.toSet()
