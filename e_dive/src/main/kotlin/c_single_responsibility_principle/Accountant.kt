...
import a_get_set_1.*
import b_get_set_2.Assistant
import b_get_set_2.Consultant
import b_get_set_2.Director
import b_get_set_2.Worker

class Accountant : Worker {
    constructor(name: String, age: Byte, salary: Int) : super(name, age, WorkerType.ACCOUNTANT, salary)
    ...
    private fun showAllItems() {
        val productCards = productsDataManager.loadProducts()
    ...
    private fun showAllWorkers() {
        val workers = workersDataManager.loadWorkers()
